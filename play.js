...
// Util: check if the grid is fully colored (used as stop condition)
...
// Util: find the best color for a given list of colorable neighbours
...
const playGame = (grid, monochromeCellsBlock) => {
  let moves = [];
